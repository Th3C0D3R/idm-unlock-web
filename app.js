...
const PATCHES = [
	...
	[
		"EB 1E 83 7C 24 24 06 75 21 83 3D ?? ?? ?? 00 00 75 18",
		"EB 1E 83 7C 24 24 06 EB 21 83 3D ?? ?? ?? 00 00 75 18",
	],
	[
		"C6 45 FC 00 8D 8D FC 04 00 00 E8 ?? ?? ?? ?? F6 86 84 00 00 00 08 75 ?? 83 3D ?? ?? ?? ?? 00 74 ?? E8 ?? ?? ?? ?? 85 C0 0F 84 ?? ?? ?? ??",
		"C6 45 FC 00 8D 8D FC 04 00 00 E8 ?? ?? ?? ?? F6 86 84 00 00 00 08 EB ?? 83 3D ?? ?? ?? ?? 00 74 ?? E8 ?? ?? ?? ?? 85 C0 0F 84 ?? ?? ?? ??"
	],
];
